...
if [[ $3 == "true" ]]
    then
        ...
        read -p ""
        mysql --user=$1 --password=$2 -h darwin-stg-20190125192319662400000001.c63j3zqcdbzb.us-west-2.rds.amazonaws.com usermeta<src/main/resources/sql/usermeta/createUserMetaDB.sql
...
if [[ $4 == "true" ]]
    then
        ...
        echo -e "Hit enter to continue or ctrl+c to abort\n"
        read -p ""
        mysql --user=$1 --password=$2 -h darwin-stg-20190125192319662400000001.c63j3zqcdbzb.us-west-2.rds.amazonaws.com darwin_batch<src/main/resources/sql/batch/createBatch.sql
